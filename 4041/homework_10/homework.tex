...
\begin{problem}{25.1-4}
  ...
  \begin{solution}
    The main operation in extend-shortest-paths is the minimum operation. $l'_{ij}$ is initialized to $\infty$ and then
    $l'_{ij}$ is compared to each $l_{ik} + w_{kj}$ for all $k$ in $1\ldots n$.
