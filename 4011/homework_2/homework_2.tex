...
\begin{problem}{6}
  ...
  \end{enumerate}
  \begin{solution}
    1. To recognize A we can think about A more simply. It starts with a 0 and ends with a 0 and may or may not have a
       between these 0's. So we can use a regular expression $0^+\Sigma^*0^+$. Because $u$ is $\Sigma^*$ it will recognize any additional 0's so that the left and right side has a balaneced amount of 0s.
    \vspace{12pt} \\
