...
\begin{problem}{3}
  ...
  \begin{solution}
    ...
    Let $B = (Q_B, \Sigma_B, \delta_A, q_b, F_B)$ \\
    ...
    \begin{proof}
      If A is regular and B is regular then M can be proved regular by construction: \\
          ...
          \noindent $\delta = \delta((Q_{Ai}, Q_{Bi}, A), a) = (\delta_A(Q_{Ai}, a), Q_{Bi}, B)$ and $\delta((Q_{Ai}, Q_{Bi}, B), b) = (Q_{Ai}, \delta_B(q_{bi}, b), A)$ so that the letters of A map to the letters of B, causing a cycling back and forth between the states of each machine. \\
